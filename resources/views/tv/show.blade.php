    ...
    <div class="tv-info border-b border-gray-800">
                ...
                <div x-show="isOpen" class="fixed inset-0 flex items-center justify-center">
                    <div class="bg-white rounded-lg p-8 w-full sm:w-1/2 md:w-2/3 lg:w-1/2">
                        ...
                        <div class="relative" style="padding-top: 56.25%;" @click.away="isOpen = false">
                            <iframe class="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{$tvShow['videos']['results'][0]['key']}}" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                @if (count($tvShow['videos']['results']) > 0)
                    <div class="mt-12">
                        <a  @click="isOpen = true" href="https://youtube.com/watch?v={{$tvShow['videos']['results'][0]['key']}}" class="inline-flex items-center bg-orange-500 text-gray-900 rounded
